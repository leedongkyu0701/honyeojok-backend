import { AddressSeedData } from '../address';

export const jejuAddresses: AddressSeedData[] = [
  ...
  { slug: 'yongnuni-oreum', address: '제주특별자치도 제주시 구좌읍 종달리 28' },
  {
    slug: 'camellia-hill',
  ...
  { slug: 'yongduam-rock', address: '제주특별자치도 제주시 용두암길 15' },
  {
  ...
  // 2) FOOD
  { slug: 'ujin-haejangguk', address: '제주특별자치도 제주시 서사로 11' },
  { slug: 'jeju-kimmanbok', address: '제주특별자치도 제주시 오라로 41' },
  { slug: 'olle-guksu', address: '제주특별자치도 제주시 월성로 39 1층' },
  { slug: 'jamae-guksu-jeju', address: '제주특별자치도 제주시 항골남길 46' },
  {
  ...
  { slug: 'naeum-coffee-bar', address: '제주특별자치도 제주시 산지로 17' },

  // 4) DRINK
  { slug: 'zencantos-winebar', address: '제주특별자치도 제주시 연삼로 145' },
  { slug: 'gwangan-solo-bar', address: '제주특별자치도 제주시 북성로 9 1층' },
  {
    slug: 'magpie-brewing-taproom',
    address: '제주특별자치도 제주시 동회천1길 23',
  },
  { slug: 'the-booze-jeju', address: '제주특별자치도 제주시 노형11길 5-4' },
];
